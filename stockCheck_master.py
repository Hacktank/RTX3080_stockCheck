...
url="https://in-and-ru-store-api.uk-e1.cloudhub.io/DR/products/en_us/USD/5438481700"

twi_realPhoneNumber = "xxxxxxxx"
twi_twilio_account_sid = 'xxxxxxxx'
twi_twilio_auth_token = 'xxxxxxxx'
twi_twilio_virtualPhoneNumber = "xxxxxxxx"
    ...
    def pollingLoop(self) -> None :
        ...
        while continuePolling:
            try:
                ...
                print("An error occured while parsing NVidia's data, trying again in a moment.")
                time.sleep(2)
                continue
            if self.pollFunc(siteData):
